...
class TestDetectTableHandler(unittest.TestCase):
    def setUp(self):
        self.log_spy = init_spy_log_handler(airhockey.handlers.detect_table.__name__)
    ...
    def make_calibrate_handler(self, *, tries, delay):
        ...
        self.calibrate_handler = DetectTableHandler(expected_markers=self.expected_markers,
