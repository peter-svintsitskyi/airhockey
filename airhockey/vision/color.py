import cv2
import numpy as np
from airhockey.geometry import Point
...
class ColorDetector(object):
    ...
    def get_positions(self, hsv, number_of_results, frame) -> list:
        lower_color = np.array([self.color_range.h_low, self.color_range.sv_low, self.color_range.sv_low])
        ...
        for i in range(number_of_results):
            ...
            result.append(self.translator.f2w(Point(cX, cY)))
